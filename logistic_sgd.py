...
class LogisticRegression(object):
    ...
    def __init__(self, rng,input, n_in, n_out):
        ...
        SelfW = self.W
        SelfB = self.b
        self.preOutput = T.dot(input, SelfW) + SelfB
        self.p_y_given_x = T.nnet.softmax(T.dot(input, SelfW) + SelfB)
        #self.p_y_given_x_printed = theano.printing.Print('this is a very important value')(self.p_y_given_x)
    ...
    def negative_log_likelihood(self, y):
        ...
        #print('NLL')
        #print(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y])
        #f_with_print = theano.function([self.p_y_given_x],self.p_y_given_x_printed)
        #a= f_with_print(self.p_y_given_x) 
        #LR1 = sum(self.W.get_value())
        #alpha=0.1
        return -(T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y]))#-alpha*LR1)
        # end-snippet-2 
